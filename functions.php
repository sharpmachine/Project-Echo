...
function custom_logo() {
  echo '<style type="text/css">
    #header-logo { background-image: url('.get_bloginfo('template_directory').'/images/echo-logo-small.png) !important; }
    </style>';
}
...
function custom_login_logo() {
  echo '<style type="text/css">
    h1 a { background-image:url('.get_bloginfo('template_directory').'/images/echo-logo.png) !important; }
    </style>';
}
...
function modify_footer_admin () {
  echo 'Created by <a href="http://www.sharpmachinemedia.com">Sharp Machine Media</a>.';
...
function remove_menu_items() {
  global $menu;
  $restricted = array(__('Pages'), __('Tools'), __('Settings'));
  end ($menu);
  while (prev($menu)){
